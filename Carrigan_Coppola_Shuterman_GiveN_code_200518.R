...
## BEESWARM BOXPLOT FOR GN-2-cat (CP/Non) w/dot colors by Language Timing & Language Modality
...
## SCATTERPLOTS of proportion correct values on GIVE-N Quantities 7, 9, 10, 12, 16 by Age (years), separated by Language Timing & Language Modality
summary(GiveN_subset$Language_Timing)
